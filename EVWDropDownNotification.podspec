...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of EVWDropDownNotification.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/EVWDropDownNotification'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'CRE8IT GmbH' => 'mobile@cre8it.ch' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/EVWDropDownNotification.git', :tag => s.version.to_s }
